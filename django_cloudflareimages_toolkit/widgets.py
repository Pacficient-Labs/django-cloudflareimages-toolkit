...
class CloudflareImageWidget(forms.TextInput):
    ...
    def render(self, name: str, value: Any, attrs: dict[str, Any] | None = None, renderer=None) -> SafeText:
        """
    ...
    def _render_fallback(self, name: str, value: Any, attrs: dict[str, Any] | None = None) -> SafeText:
        """
